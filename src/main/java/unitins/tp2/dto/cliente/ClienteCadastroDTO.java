...
public record ClienteCadastroDTO(
        ...
        @NotBlank(message = "O campo nome do endereço não pode ficar em branco")
        String enderecoNome,

        @NotBlank(message = "O campo logradouro não pode ficar em branco") 
        String enderecoLogradouro,

        @NotBlank(message = "O campo número não pode ficar em branco") 
        String enderecoNumero,

        @NotBlank(message = "O campo bairro não pode ficar em branco")
        String enderecoBairro,
        
        String enderecoComplemento,

        @NotBlank(message = "O campo cep não pode ficar em branco")
        String enderecoCep,
        
        @NotBlank(message = "O campo cidade não pode ficar em branco") 
        String enderecoCidade,

        @NotBlank(message = "O campo estado não pode ficar em branco") 
        String enderecoEstado,

        @NotBlank(message = "O campo login não pode ficar em branco") 
        String login,
